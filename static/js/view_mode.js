...
(function() {
  ...
  fotoramaGal = function() {
    return $.each($('.sortable-img'), function(index, val) {
      ...
      $(val).replaceWith('<div class="fotorama" data-fit="cover" style="margin-left:21%" data-allowfullscreen="true"  data-nav="thumbs"  data-width="73%"  data-ratio="16/9">' + fotorama_img(src_arr) + '<div>');
