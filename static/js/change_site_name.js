...
(function() {
  ...
  $('body').on('click', '#edit_site_name_button', function() {
    ...
    $('#change_site_name_block').append('<span id="name_edit_span"> <input id="input_site_name" type="text" maxlength="30" size=10 value=""> <span class="btn for-span btn-xs glyphicon glyphicon-check" id="change_site_name_button"></span> </span>');
  ...
  end_change_name = function(site_name) {
    ...
    $('#change_site_name_block').append('<span id="name_not_edit_span" name_project = ""> <span  class="btn for-span glyphicon glyphicon-edit" id="edit_site_name_button"> </span> </span>');
